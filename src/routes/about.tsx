...
const values = [
  ...
  { n: "02", h: "Answer the objection on the page", p: "What it costs, whether they will suit the room, what happens if someone cancels. If you have to ring us to find out, we have failed at the page." },
  { n: "03", h: "Earn from the booking, not the confusion", p: "Speakers pay a flat listing fee. We do not make more money when you understand less, which is the only reason this model works." },
  { n: "04", h: "Both sides, or neither", p: "A marketplace that treats speakers as inventory ends up with bad inventory. Speakers set their own fees and keep their own relationships." },
];
  ...
  return (
    <Page>
      ...
      <section className="container-x pb-16 pt-10">
        <h1 className="display max-w-[14ch] text-[length:var(--display-lg)]">Trust is the product</h1>
        <p className="mt-8 max-w-[58ch] text-lg text-[var(--ink-2)]">
          Booking a speaker means committing thousands of dollars to a stranger, usually on
          someone else's budget, usually without seeing them work first. Everything we build
          exists to make that decision less frightening.
        </p>
      </section>
      ...
      <section className="rule-open container-x section-y">
        ...
        <div className="mt-8 grid max-w-[62ch] gap-5 text-[var(--ink-2)]">
          <p>
            Ask a bureau what a speaker charges and you will be asked for your budget first. That
            is not rudeness, it is the business model. When the buyer cannot see the fee, the
            margin in the middle is whatever the market will bear, and the 20 to 30 per cent
            sitting there is invisible by design.
          </p>
          <p>
      ...
      <section className="container-x section-y">
        ...
        <ol className="mt-10 border-t border-[var(--line)]">
          {values.map((v) => (
            <li key={v.n} className="grid gap-4 border-b border-[var(--line)] py-10 md:grid-cols-[80px_1fr_1.2fr] md:gap-12">
      ...
      <section className="container-x pb-24">
        <div className="rule-open grid gap-0 pt-10 md:grid-cols-2">
          <div className="border-[var(--line)] py-10 md:border-r md:pr-12">
            ...
            <div className="mt-8">
              <ButtonLink to="/speakers" variant="ghost">Browse speakers</ButtonLink>
            </div>
          </div>
          <div className="py-10 md:pl-12">
            ...
            <div className="mt-8">
              <ButtonLink to="/for-speakers" variant="ghost">Join the roster</ButtonLink>
            </div>
          </div>
        </div>
      </section>
